...
\begin{frame}[c]{Genotype reconstruction (one mouse)}
  \figh{Figs/geno_reconstruct.png}{0.9}
...
\begin{frame}[c]{Percent missing vs. number of crossovers}
  \only<1|handout 0>{\figh{Figs/missing_v_nxo.png}{0.9}}
  \only<2|handout 0>{\figh{Figs/missing_v_nxo_labeled.png}{0.9}}
  \only<3|handout 0>{\figh{Figs/missing_v_nxo_subset.png}{0.9}}
  \only<4>{\figh{Figs/missing_v_nxo_subset_labeled.png}{0.9}}
...
\begin{frame}[c]{Crossovers by generation}
  \figh{Figs/nxo_by_generation.png}{0.9}
...
\begin{frame}[c]{Percent genotyping errors}
  \only<1|handout 0>{\figh{Figs/percent_geno_errors.png}{0.9}}
  \only<2>{\figh{Figs/percent_geno_errors_subset.png}{0.9}}
