...
source("colors.R")
color[1] <- brocolors("web")["blue"]
color[4] <- brocolors("web")["green"]
bgcolor <- "white"
...
par(mfrow=c(1,2))
par(mar=c(4.1,5.1,2.6,1.6), col.lab=color[1],
    bg=bgcolor, cex.axis=1.2, cex.lab=1.3, las=1, col.main="orange2", cex.main=1.7)
plot(0, 0, type="n", xlab="", ylab=paste("expression  of ", e1), xaxt="n",
...
par(mar=c(4.1,6.1,2.6,0.6), col.lab=color[1],
    bg=bgcolor, cex.axis=1.2, cex.lab=1.3, las=1)
y1nqr <- nqrank(y1)
...
points(g[,1]+u, y1, lwd=2, col="gray80")
points((g[,1]+u)[m], y1[m], bg=color[2], col="black", lwd=1, pch=21)
axis(side=1, at=1:3, c("BB", "BR", "RR"))
title(xlab=paste("Genotype  at ", marker1))
dev.off()
...
par(mar=c(4.1,5.1,0.1,0.1), col.lab=color[1],
    bg=bgcolor, cex.axis=1.2, cex.lab=1.3, las=1)
plot(y2, col="gray80", lwd=2,
     xlab=paste("expression  of ", e2[1]),
     ylab=paste("expression  of ", e2[2]))
points(y2[m,], col="black", bg=color[c(2,4,1)][g[m,2]], lwd=1, pch=21)
...
par(mar=c(4.1,5.1,0.1,0.1), col.lab=color[1],
    bg=bgcolor, cex.axis=1.2, cex.lab=1.3, las=1)
plot(y3, col="gray80", lwd=2,
     xlab=paste("expression  of ", e3[1]),
     ylab=paste("expression  of ", e3[2]))
points(y3[m,], col="black", bg=color[c(2,4,1)][g[m,3]], lwd=1, pch=21)
text(-0.9, -0.05, "BB", col=color[1], cex=1.5)
text(-0.25, 0.25, "BR", col=color[4], cex=1.5)
text(0.05, 0.4, "RR", col=color[2], cex=1.5)
u <- par("usr")
