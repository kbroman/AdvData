...
bgcolor <- "white"
color <- brocolors("crayons")[c("Denim", "Jazzberry Jam", "Pine Green")]
fgcolor <- "black"
...
plot(out, col=color[1], ylab="LOD score", bandcol="gray90", incl.markers=FALSE, yaxs="i",
     ylim=c(0, 9))
...
for(y in yl)
  segments(mx.x, mx.y, xl[1], y, lty=2, col="gray30", lend=1, ljoin=1)
