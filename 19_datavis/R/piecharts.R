...
pdf("../Figs/piecharts.pdf", height=5.5, width=8.5, pointsize=12)
...
pdf("../Figs/piecharts_3d.pdf", height=5.5, width=8.5, pointsize=12)
par(bg=bgcolor, fg=fgcolor)
par(mar=rep(1.1, 4))
par(mfrow=c(2,2))
for(i in 1:2)
...
pdf("../Figs/piecharts_3d_w_bars.pdf", height=5.5, width=8.5, pointsize=12)
...
pdf("../Figs/piecharts_w_bars.pdf", height=5.5, width=8.5, pointsize=12)
par(bg=bgcolor, fg=fgcolor, col.axis=fgcolor)
par(mfrow=c(2,2))
par(mar=rep(1.1, 4))
for(i in 1:2)
