...
pdf("../Figs/scale_fig1.pdf", height=5, width=10, pointsize=28)
...
text(x[1]+2, y-5, "genotypes", col=bgcolor, adj=c(0, 0))

rect(x[2], y, x[2]+xw[2], y-yw, col=color[2], border=color[2], lend=1, ljoin=1)
text(x[2]+2, y-5, "phenotypes", col=bgcolor, adj=c(0, 0))

dev.off()


pdf("../Figs/scale_fig2.pdf", height=5, width=10, pointsize=28)
par(bg=bgcolor, mar=rep(0.1, 4), bty="n")
