...
\note{
  ...
  Some of the code is really terrible and complicated. Two-dimensional
  genome scans to identify pairs of interacting loci is accomplished
  through a function that is like 1800 lines long, and the C code
  related to that aspect is like 20\% of the C code in the package.

  Short-term efforts to fix problems were accomplished via band-aids
  that made the code more complicated and confusing and harder to
  maintain.
