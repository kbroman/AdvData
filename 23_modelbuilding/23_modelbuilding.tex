...
\begin{frame}{Chr 1: $\mathsf{\lod_i}$ and $\mathsf{\lod_{av1}}$}
...
%\item You {\hilit can't know} the performance of your procedure with your
...
\begin{frame}{Controlling for chr 4}
...
\begin{frame}{Drop-one-QTL table}
...
\begin{frame}{Add an interaction?}
