...
\title{Organizing projects;\\exploratory data analysis;\\collaboration}
...
\note{I'm trying to cover three things here: how to organize data
  analysis projects, so in the end the results will be reproducible
  and clear, how to capture the results of exploratory data
  analysis, and how to organize collaborative projects.
  ...
  Regarding collaboration, the key thing is about communication, to
